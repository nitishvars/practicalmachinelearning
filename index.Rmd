...
predictionsDT <- predict(modFitDT, Validation)
...
#predictionsRF <- predict(modFitRF, Validation)
#confusionMatrix(predictionsRF , Validation$classe)
```

### Final Model Selection
As expected Random Forest Algorithm has performed better than Decision Tree Algorithm. So we choose Random Forest model as final model.
